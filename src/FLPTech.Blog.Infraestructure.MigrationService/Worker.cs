...
namespace FLPTech.Blog.Infraestructure.MigrationService;
    ...
    IHostApplicationLifetime hostApplicationLifetime) : BackgroundService
{
        ...
        AppDbContext dbContext, CancellationToken cancellationToken)
    {
        ...
        await strategy.ExecuteAsync(async () =>
        {
            ...
            await SeedArticlesAsync(dbContext, cancellationToken);
    ...
    private static async Task SeedArticlesAsync(AppDbContext dbContext, CancellationToken cancellationToken)
    {
